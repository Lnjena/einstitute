...
import {ROUTER_DIRECTIVES, ROUTER_PROVIDERS, RouteConfig, Router, RouteParams, Route, LocationStrategy, HashLocationStrategy} from "angular2/router";
...
@RouteConfig([
    { path: '/menu', name: 'CreateActivity', component: ActivityMainComponent },
